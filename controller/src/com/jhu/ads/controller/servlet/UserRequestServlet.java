...
public class UserRequestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
	    ...
	    if(wowzaServer == null) {
	        System.out.println("No free Wowza Server Instance found. So redirecting this user to a webserver.");
	        String webServerURL = ConfigMgr.getInstance().getWebServerURL();
            ...
            if(userInfoStr!=null && !userInfoStr.equals("") ) {
                ...
                printWriter.println("<tr> <td> Client Addr: </td> <td>" + userInfo.getLocationIp() + "</td> </tr>");
